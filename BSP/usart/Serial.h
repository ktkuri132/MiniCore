...
// 颜色代码
#define ANSI_COLOR_BLACK 30                                      // 黑色
#define ANSI_COLOR_RED 31                                        // 红色
#define ANSI_COLOR_GREEN 32                                      // 绿色
#define ANSI_COLOR_YELLOW 33                                     // 黄色
#define ANSI_COLOR_BLUE 34                                       // 蓝色
#define ANSI_COLOR_MAGENTA 35                                    // 洋红色
#define ANSI_COLOR_CYAN 36                                       // 青色
#define ANSI_COLOR_WHITE 37                                      // 白色

// 背景颜色代码
#define ANSI_BG_COLOR_BLACK 40                                   // 黑色背景
#define ANSI_BG_COLOR_RED 41                                     // 红色背景
#define ANSI_BG_COLOR_GREEN 42                                   // 绿色背景
#define ANSI_BG_COLOR_YELLOW 43                                  // 黄色背景
#define ANSI_BG_COLOR_BLUE 44                                    // 蓝色背景
#define ANSI_BG_COLOR_MAGENTA 45                                 // 洋红色背景
#define ANSI_BG_COLOR_CYAN 46                                    // 青色背景
#define ANSI_BG_COLOR_WHITE 47                                   // 白色背景
